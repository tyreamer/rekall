...
def test_sanitize_url():
    ...
    assert sanitize_url("https://github.com/org/repo/pull/1?access_token=secret") == "https://github.com/org/repo/pull/1"
...
def test_append_idempotent_dedupes(tmp_path):
    ...
    store.append_jsonl_idempotent("test_stream", {"log_id": "123", "data": "world"}, "log_id")
